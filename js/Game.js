class Game {
  ...
  start() {
    ...
    bike1 = createSprite(50, height - 100);
    bike1.addImage("bike1", bike1_img);
    bike1.scale = 0.2;

    bike2 = createSprite(300, height - 100);
    bike2.addImage("bike1", bike1_img);
    bike2.scale = 0.2;

    bike2.addImage("blast",blastImage)

    bike3 = createSprite(550, height - 100);
    bike3.addImage("bike1", bike1_img);
    bike3.scale = 0.2;

    bike4 = createSprite(750, height - 100);
    bike4.addImage("bike1", bike1_img);
    bike4.scale = 0.2;
